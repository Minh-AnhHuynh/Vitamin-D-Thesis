...
comme étant associée bénéfique pour la santé osseuse concernant la
majorité de la population générale. Les concentrations de calcitriol
supérieures à 30 ng/mL ne sont pas associées à un bénéfice accru selon
l'\ac{IOM} \autocite[Caprio.2017]{IOM.2011}.
...
\caption{\label{tbl-seuil}Seuils d'adéquation de la vitamine D par
différentes sources.}\tabularnewline
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
\textless{} 12 & Déficience & Déficience & \\
...
\hypertarget{tbl-AJR}{}
\begin{longtable}[]{@{}cccc@{}}
\caption{\label{tbl-AJR}Apports journaliers recommandés de la vitamine D
(UI/j). La mention de AJR indique que l'apport couvre les besoins
minimes de 97.5\% population pour une concentration de 20 ng/mL selon
l'\ac{IOM}. La société endocrine vise un AJR pouvant maintenir une
concentration de 30 ng/mL \autocite{Pramyothin.2012}.}\tabularnewline
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
\textless{} 1 an & 400 & 600 & 400-1000 \\
\textgreater{} 1 an & 600 & & 600-1000 \\
\textgreater{} 19 ans & 600 & & 1500-2000 \\
\textgreater{} 70 ans & 800 & & 1500-2000 \\
\end{longtable}
...
Une méta-analyse de \textcite{Garland.2014} a examiné la relation entre
calcidiol sérique et mortalité toutes causes confondues, ajustée à
l'âge. Malgré la grande hétérogénéité des études, ce qui rend l'analyse
conservative, les auteurs ont trouvé une association inverse entre la
mortalité toutes causes confondues et le calcidiol, avec un risque
(hazard ratio) pour les patients présentant les concentrations les plus
basses (0 - 9 ng/mL) est de 1,9, significativement plus important que
pour ceux ayant une concentration supérieure ou égale à 40 ng/mL. Cette
étude montre selon \textcite{Garland.2014} et
\textcite{Papadimitriou.2017} que la cible thérapeutique de 30 ng/mL,
retenue par l'IOM, serait trop basse. De plus, selon
...
catégories de 40 ng/mL à \textgreater70 ng/mL (Figure 2.7).
...
\caption{\label{fig-vd-hazard-ratio}Hazard ratio de mortalité ajustés
pour l'âge, dans 32 études sur l'association entre le calcidiol et la
mortalité toutes causes confondues \textcite{Garland.2014} : 1966-2013.
25(OH)D = 25-hydroxyvitamine D.}

\end{figure}

De plus, \textcite{Veugelers.2014} ont réanalysé les données utilisées
par l'\ac{IOM} lors de la détermination du seuil adéquat de vitamine D,
et ont trouvé que l'\ac{IOM} avait sous-estimé les concentrations
nécessaires pour atteindre leurs recommandations. Ainsi, la courbe de
régression réévaluée révèle que 600 UI/j de cholécalciférol permettrait
d'obtenir pour 97.5\% de la population, une concentration en moyenne
supérieure à 10.72 ng/mL (valeurs converties de nmol/mL), bien en deçà
des 20 ng/mL recommandé par l'\ac{IOM}, et qu'il faudrait en réalité,
avec les données utilisées par l'\ac{IOM}, une dose minimale de 8895
UI/j pour atteindre des valeurs de 20 ng/mL ou plus. Les auteurs notent
que cette dose est nettement supérieure à la dose journalière
recommandée par l'\ac{IOM} et bien supérieure à la limite supérieure de
4000 UI fixée par l'\ac{IOM} (Figure~\ref{fig-vd-pk-estim}). Cette
analyse est confirmée par \textcite{Heaney.2015} qui effectue des
calculs similaires sur des données de patient différente venant de la
base de donnée GrassrootsHealth, où il existe des données concernant des
prises de cholécalciférol allant jusqu'à 10 000 UI/j, contrairement aux
données prises par l'\ac{IOM} où il existe une incertitude puisque les
prises n'allaient jusqu'à 2400 UI/j. Ainsi, l'analyse de
...
carences à des fins de « bonne santé » osseuse. Elle permet de prévenir
le rachitisme chez les enfants et l'ostéoporose chez les adultes et
surtout chez les personnes âgées. De plus, le calcitriol, forme active
de la vitamine D, est utilisé pour traiter des maladies métaboliques
liées à la thyroïde, telle que les hypoparathyroïdies, les
ostéodystrophies rénales, les ostéomalacies vitamino-résistantes, les
pseudo-hypoparathyroïdies et les rachitismes vitamino-résistants
\autocite{VIDAL.2013}.
