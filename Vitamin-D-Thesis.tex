...
D dans le monde. Les données sont résumées dans la \Cref{tab:statut-vd}.

\begin{table}[h]

\caption[Résumé du statut en vitamine D de la population par continent.]{\label{tab:statut-vd}Résumé du statut en vitamine D de la population par continent. Données calculées à partir de  extcite{Schoor.2017}.}
\centering
\begin{tabular}[t]{lrrr}
\toprule
Continent & Weighted\_Mean & Weighted\_SD & Percentage.below.20.ng.mL\\
\midrule
Asia & 19.4 & 2.9 & 58.4\\
Middle East & 21.1 & 1.0 & 48.5\\
Africa & 21.2 & 7.7 & 25.1\\
South America & 24.2 & 3.3 & 33.6\\
Europe & 24.8 & 3.7 & 29.9\\
\addlinespace
North America & 26.2 & 3.9 & 29.6\\
\bottomrule
\end{tabular}
\end{table}
