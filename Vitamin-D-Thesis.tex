...
D dans le monde. Les données sont résumées dans la \Cref{tbl-statut-vd}.
...
\caption[Résumé du statut en vitamine D de la population par continent.]{\label{tab:tbl-statut-vd}Résumé du statut en vitamine D de la population par continent. Données calculées à partir de @Schoor.2017}
\centering
