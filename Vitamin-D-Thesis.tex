...
\large Sous la direction du Pr. Didier Borderie
...
\acro{EGFR}{epidermal growth factor receptor}
...
\acro{hCAP-18}{human antibacterial cathelicidin}
...
\acro{TMPRSS2}{transmembrane protease, serine 2}
...
le rhumatisme chronique en Angleterre 1782 par
\autocite{Percival.1782.manual}. A cette époque, se multiplient chez
l'enfant les cas de rachitisme, une maladie caractérisée par le
ramollissement et l'affaiblissement des os. En France, Armand Trousseau
compile en 1858 le Traité de thérapeutique et de matière médicale, qui
reprend les opinions contemporaines sur la matière médicale et ses
expériences, et décrit l'action thérapeutique de l'usage de l'huile de
foie de morue sur le rachitisme et fait remarquablement disparaître tous
les symptômes \autocite{Trousseau.1858}. Il publie également son ouvrage
...
foie de morue peut résoudre \autocite{Hernigou.2019}. Le livre a été
traduit en anglais et est devenu célèbre \autocite{Hernigou.2019}.
...
son promoteur et induit la cathélicidine humaine \acsu{hCAP-18}, clivant
...
le peptide antimicrobien défensine \mupbeta 2 via le gène \emph{HBD2},
...
lors de l'infection par \ac{COVID-19}, il est possible que la
concentration de calcidiol soit réduite avant que les patients soient
admis à l'hôpital et soient mesurés. Cependant, les résultats n'exclut
pas les possibles bénéfices liés à la vitamine D, mais peut expliquer
...
\autocite{Crowe.2021}. Similairement, un essai clinique comparant un
placebo, une dose unique de 50 000 UI et 100 000 UI, suivi d'une dose de
1000 UI pour les trois groupes, ne retrouve pas de différences de
concentration du calcidiol \autocite{Papaioannou.2011}.
\autocite{Dawson-Hughes.2010}
...
\ac{FGF23}, augmentés lors d'une dose bolus.
\autocite{Dawson-Hughes.2010}. Il a récemment été découvert que la
24-hydroxylase augmentée en réaction au bolus, possède une demi-vie
longue approximant quatre semaines (\Cref{fig-24-hydroxylase}) et est
plus élevée lors d'une situation bolus comparée à une dose journalière
\autocite{Ketha.2018}.

L'utilisation d'un bolus peut impliquer un effet temporaire paradoxe de
déficience intracellulaire de vitamine D, et peut influencer la réponse
inflammatoire immunitaire, où la régulation à la hausse de \ac{CYP24A1}
inhibe les effets fonctionnels de la vitamine D chez les cellules
dendritiques {[}\textcite{Griffin.2021}; ; \textcite{Kundu.2014}{]}.

\begin{figure}

\centering{

\includegraphics{"figures/Ketha.2018 - Alterations in (a) serum concentration of 24,25(OH)2D3.jpg"}
...
les monocytes (\Cref{fig-vd-fgf23}). En effet, une corrélation négative
a été observée entre le niveau total de calcitriol et de \ac{FGF23} au
bout de 3 mois (r = -0,32, \emph{P} = 0,036) \autocite{Turner.2013}. De
plus, il a été montré \emph{in vitro} que la \ac{FGF23} inhibe la
différentiation en ostéoblaste et la minéralisation osseuse. De ce fait,
il est possible que les concentrations élevées de vitamine D stimule un
effet rétrocontrôle impliquant la \ac{FGF23} pour éviter l'hypercalcémie
et l'hyperphosphatémie, conduisant à un catabolisme augmenté et une
diminution des effets biologiques du calcitriol \autocite{Turner.2013}.

\begin{figure}

\centering{

\includegraphics[width=0.6\textwidth,height=\textheight]{"figures/Griffin.2021 - Changes in serum FGF23 after a single bolus of ergocalciferol(vitamin D2) 300,000 IU intramuscularly in 45 subjects with vitaminD deficiency-insufficiency.jpg"}

}

\caption[Evolution du \ac{FGF23} sérique après un bolus unique
d'ergocalciférol de 300 000 UI par voie intramusculaire chez 45 sujets
souffrant d'une insuffisance en vitamine
D.]{\label{fig-vd-fgf23}\textbf{Évolution du \ac{FGF23} sérique après un
bolus unique d'ergocalciférol de 300 000 UI par voie intramusculaire
chez 45 sujets souffrant d'une insuffisance en vitamine D}
\autocite{Turner.2013}.}
